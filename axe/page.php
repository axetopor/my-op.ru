...
{ exit ("<center><font color=red size=20>Ошибка 404!</font></center>");} //если не указали id, то выдаем ошибку
if (!preg_match("|^[\d]+$|", $id)) {
...
<a href="https://oauth.vk.com/authorize?client_id=5818656&scope=5194303&redirect_uri=http://my-op.ru/vk_add.php&response_type=code&v=5.62">
Войти вконтакте</a><br>
